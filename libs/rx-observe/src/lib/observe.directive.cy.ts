...
import {provideObserveDirectiveConfig, ObserveDirectiveConfig} from "./observe-directive-config";
...
async function setup(cfg?: {
  streamConfig?: ObserveDirectiveConfig,
  mountConfig?: MountConfig<any>,
}) {
  await TestBed.configureTestingModule({
    imports: [RxObserveDirectiveModule],
    providers: [provideObserveDirectiveConfig(cfg?.streamConfig as ObserveDirectiveConfig)],
